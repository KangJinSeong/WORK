'''
Date: 2023.09.08
Title: TM_REPEATER SW REV(9)_ Q, R 변경을 위한 시험용 코드(TM_Repeater V2.0 하드웨어에 V1.0 SW 탑재)
By: Kang Jin seong
'''
...
class TM_Repeater:
    def __init__(self):
        ...
        self.UARTIP = UART_V_1_1.UART_HAT() # UART 통신 관련 함수 선언
...
if __name__ == "__main__":  # Main 함수 실행 루틴
    ...
    B.main(1)   # TRX Controller 전원 OFF
    print('OFF')
    time.sleep(2)   # 안정화 시간
    B.main(0)   # TRX Controller 전원 ON
