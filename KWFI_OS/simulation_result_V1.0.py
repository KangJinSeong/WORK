...
g111 = chirp(t, f0= 30020, t1 = 0.128, f1 = 34000, method = 'linear')
g2 = chirp(t, f0= 34000, t1 = 0.128, f1 = 30000, method = 'linear') # DOWN-chirpping signal(coefficient for bit 1)
g22 = chirp(t, f0= 34000, t1 = 0.128, f1 = 30050, method = 'linear')
g222 = chirp(t, f0= 34000, t1 = 0.128, f1 = 30030, method = 'linear')
'''
